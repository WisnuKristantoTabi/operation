...
$routes->group('', ['filter' => 'auth'], function($routes) {
	...
	$routes->get('/schedule/(:num)/edit', 'Schedule::edit/&1');
	$routes->post('/schedule/(:num)/update', 'Schedule::update/&1');
	$routes->get('/schedule/(:num)/delete', 'Schedule::delete/&1');
	$routes->post('/schedule', 'Schedule::save');
	$routes->get('/schedule-export', 'Schedule::exportExcel');
	

	$routes->get('/operation-add', 'Operation::add');
	$routes->get('/operation', 'Operation::index');
	$routes->post('/operation', 'Operation::save');
	$routes->post('/operation-import', 'Operation::import');
	$routes->get('/operation-show/(:num)/(:num)', 'Operation::showByDate/$1/$2');
	$routes->get('/operation-download/(:num)/(:num)', 'Operation::download/$1/$2');
	$routes->post('/operation-find', 'Operation::find');

	$routes->get('/ship', 'Ship::index');
	$routes->get('/ship-add', 'Ship::add');
	$routes->post('/ship', 'Ship::save');
	$routes->get('/ship/(:num)/edit', 'Ship::edit/&1');
	$routes->get('/ship/(:num)/delete', 'Ship::delete/&1');

});

$routes->group('/api', ['filter' => 'cors'], function($routes) {
	$routes->get('schedule', 'API::Schedule');
});

$routes->get('/sosmed', static function () {
	return view('apps/sosmed');
});
...
$routes->post('auth-register', 'Register::save');
