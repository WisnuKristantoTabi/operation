                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p class="card-title-desc">Edit Data Kapal</p>
                            </div>
                                ...
                                <div class="row">
                                    <form action="<?php echo base_url('/ship'); ?>" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="shipname" type="text" value="<?= $ships['ship_name']?>" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Tipe Kapal</label>
                                            <input class="form-control" name="shiptype" type="text" value="<?= $ships['ship_type']?>" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Gross Ton</label>
                                            <input class="form-control" name="grosston" type="number" value="<?= $ships['gross_ton']?>" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Panjang Kapal</label>
                                            <input class="form-control" name="length" step=any type="number" value="<?= $ships['length']?>" >
                                        </div>
                                        <div class="mb-3">
                                            <label for="example-text-input" class="form-label">Lebar</label>
                                            <input class="form-control" name="width" step=any type="number" value="<?= $ships['width']?>" >
                                        </div>
                                        <div class="mb-3">
